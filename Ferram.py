#Ferram.py
#CBTIS89
#ORLANDO FERRAM NAJERA TREMLLLO
...
# -------------------------
ventana = tk.Tk()
ventana.title("Punto de Venta - Botanas")
...
estilo = ttk.Style()
estilo.theme_use("clam")  # Necesario para permitir colores personalizados
...
estilo.configure(
    ...
    foreground="black",
    bordercolor="#000080",  # Azul marino
    borderwidth=3,
    focusthickness=3,
    focuscolor="#000080"
)

# Cambiar color cuando el mouse pasa encima
estilo.map(
    "BotonAzul.TButton",
    background=[("active", "#87CEEB")],  # Azul más brillante
    bordercolor=[("active", "#000060")]  # Azul marino más fuerte
)

btn_reg_prod = ttk.Button(ventana, text="Registro de Productos", style="BotonAzul.TButton", command=abrir_registro_productos)
btn_reg_prod.pack(pady=10)

btn_reg_ventas = ttk.Button(ventana, text="Registro de Ventas", style="BotonAzul.TButton", command=abrir_registro_ventas)
btn_reg_ventas.pack(pady=10)

btn_reportes = ttk.Button(ventana, text="Reportes", style="BotonAzul.TButton", command=abrir_reportes)
btn_reportes.pack(pady=10)

btn_acerca = ttk.Button(ventana, text="Acerca de", style="BotonAzul.TButton", command=abrir_acerca_de)
